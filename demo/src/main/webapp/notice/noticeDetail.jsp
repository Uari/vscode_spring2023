    ...
    <html>
      <head>
        ...
        <script type="text/javascript">
          const noticeDelete = (n_no) => {
            //console.log(n_no);
            location.href="/notice/noticeDelete?n_no="+n_no;
          };
          const noticeList = () => {
        ...
        <div class="container">
          ...
          <div style="width: 58rem">
            ...
            <div class="detail-link">
              <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#noticeUpdateForm">수정</button>
              &nbsp;
              <button class="btn btn-warning" onclick="noticeDelete('<%=rmap.get("N_NO")%>')">삭제</button>
              &nbsp;
              <button class="btn btn-success" onclick="noticeList()">공지목록</button>
            </div>
          </div>
